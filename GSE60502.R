...
library(data.table)
# Loading data
GPL10558 <-data.table::fread("C:/GSE60502/GPL96-57554.txt",skip ="ID")
exprSet<-read.table("C:/GSE60502/GSE60502_series_matrix.txt",comment.char="!",
                    stringsAsFactors=F,
                    sep="\t",
                    header=T)
# Group the samples
sample.type <- read.table("C:/GSE60502/sample_Type.txt",
                          header = F, sep = "\t")
...
write.csv(result,"C:/GSE60502/GSE60502-Differentially expressed genes.csv", 
