...
1. Navigate to the TCGA‑LIHC folder and open scripts/TCGA_DEG_analysis.R.

2. Replace the file paths with the relative paths inside the repository:
...
3. Run the script from R (set working directory to the TCGA‑LIHC folder first):
...
1. Create a folder for the dataset (e.g., GSE45114/, GSEXXXXX/, GSEYYYYY/) and place the corresponding input files inside the input/ subfolder.

2. Copy the script template (GSE45114_DEG_analysis.R) into the scripts/ subfolder and rename it appropriately.

3. Modify the file paths inside the script to use relative paths:
...
4. Run the script from R (set working directory to the dataset’s root folder):
